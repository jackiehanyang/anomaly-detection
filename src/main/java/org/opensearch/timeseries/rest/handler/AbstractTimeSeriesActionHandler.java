...
public abstract class AbstractTimeSeriesActionHandler<T extends ActionResponse, IndexType extends Enum<IndexType> & TimeSeriesIndex, IndexManagementType extends IndexManagement<IndexType>, TaskCacheManagerType extends TaskCacheManager, TaskTypeEnum extends TaskType, TaskClass extends TimeSeriesTask, TaskManagerType extends TaskManager<TaskCacheManagerType, TaskTypeEnum, TaskClass, IndexType, IndexManagementType>>
    ...
    private void getFlattenResultAliasIndex(Config existingConfig, ActionListener<T> listener, String id, boolean indexingDryRun) {
        String flattenResultIndexAlias = timeSeriesIndices.getFlattenedResultIndexAlias(existingConfig.getCustomResultIndexOrAlias(), existingConfig.getId());
        GetAliasesRequest getAliasesRequest = new GetAliasesRequest(flattenResultIndexAlias);
        client.admin().indices().getAliases(getAliasesRequest, ActionListener.wrap(
                getAliasesResponse -> {
    ...
    private void deleteAlias(String indexName, String aliasName, Config existingConfig, ActionListener<T> listener, String id, boolean indexingDryRun)  {
        ...
        client.admin().indices().aliases(indicesAliasesRequest, ActionListener.wrap(
    ...
    private void deleteIngestPipeline(Config existingConfig, ActionListener<T> listener, String id, boolean indexingDryRun) {
        ...
        client.admin().cluster().deletePipeline(new DeletePipelineRequest(pipelineId), ActionListener.wrap(
